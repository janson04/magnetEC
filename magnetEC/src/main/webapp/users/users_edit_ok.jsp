    ...
    <div class="row">
      ...
      <div class="col-9 productDetail">
        ...
        <div class="row col-12 col-md-10 mx-auto">
          <div class="fs-3 fw-bold text-center">會員資料編輯成功</div>
          <div class="form-text text-center mb-3">Member information update successfully</div>
        </div>
        <hr/>
        <div class="container" id="loginok">
          <div class="fs-2 fw-bold text-center text-success">成功更新會員資料</div>
          <div class="fs-5 text-center">您可開始瀏覽選購商品，或查詢您的訂單資訊。</div>
