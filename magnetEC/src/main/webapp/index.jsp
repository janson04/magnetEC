    ...
    <div class="row">
      ...
      <div class="col-sm-6" id="ND">
        ...
        <a href="product?magnetType=ND&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">燒結釹鐵硼磁石目前為磁力最強的磁鐵，廣泛應用在各領域，尤其是電子電機、醫療機器、包裝、五金機械、航空科技
        		<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
      <div class="col-sm-6" id="FE">
        ...
        <a href="product?magnetType=FE&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">鐵氧體磁石是世界上使用最多的磁石材料，主要是以乾溼壓模或切割製成，磁石原料是三氧化二鐵，主要運用在電子電機、醫療產業、自動化產業。
        		<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
      <div class="col-sm-6" id="SM">
        ...
        <a href="product?magnetType=SM&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">釤鈷永久磁石是由稀土元素，氧化釤、氧化鈷等金屬化合物，經高溫熔煉、製粉、壓胚與結燒而成，具有耐酸鹼跟耐高溫特性，且尺寸精準、磁力接近於釹鐵硼強力磁鐵。可用在DC直流無刷馬達、泵浦、鐘錶元件、強力發電機等用途
        		<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
      <div class="col-sm-6" id="RM">
        ...
        <a href="product?magnetType=RM&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">軟性永久磁石是將鐵氧體磁粉或釹鐵硼磁粉混合橡膠、樹脂與其他材料後擠壓、射出、沖型或壓延製片方式製成條狀、或捲狀。主要運用在廣告文宣、禮贈品、機械零件、馬達零件等用途。
    			<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
      <div class="col-sm-4" id="AL">
        ...
        <a href="product?magnetType=AL&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">鋁鎳鈷合金永久磁石是一種金屬合金磁石，製造方式分鑄造成型及燒結成型，具有較高溫度係數及不易破碎特性。主要運用在揚聲器元件、發電機元件、儀錶元件等用途。
        		<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
      <div class="col-sm-4" id="MQ">
        ...
        <!-- <a href="product?magnetType=MQ&page=1" style="color: black; text-decoration: none;"> -->
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">主原料同燒結釹鐵硼，但製程不一樣<br>需要開模具製作，雖然磁力稍弱於燒結釹鐵硼的，但因為模具生產可製作較為特殊的設計。可用於震動馬達元件、步進馬達元件、磁簧感應元件等用途。
        	</p>
        <!-- </a> -->
      </div>
      <div class="col-sm-4" id="PM">
        ...
        <a href="product?magnetType=PM&page=1" style="color: black; text-decoration: none;">
        	...
        	<p data-bottom-top="transform: translateY(-50px);opacity: 0" data-center="transform: translateY(0px);opacity: 1">塑膠射出磁石擁有高精密度、形狀複雜、能多極充磁，且擁有良好的韌性不易碎裂等特性，可運用於耳機元件、印表機用磁棒、無刷馬達元件等用途。
        		<span style="color: blue;">　點擊購買🛒</span>
        	</p>
        </a>
      </div>
