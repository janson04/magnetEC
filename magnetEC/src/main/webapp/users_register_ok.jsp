...
<section id="left_zone">
  <div class="container">
    <div class="row">
      <!--左方導覽-->
      <div class="col-3">
        <div class="list-group"><a class="list-group-item list-group-item-action active" aria-current="true">會員專區</a><a class="list-group-item list-group-item-action" href="">會員登入</a><a class="list-group-item list-group-item-action" href="">會員註冊</a><a class="list-group-item list-group-item-action" href="">訂單查詢</a></div>
      </div>
      <!--右方部分:會員註冊成功-->
